...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_restaurant" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#8b0614f4#;
   pragma Export (C, u00001, "restaurantB");
   ...
   u00137 : constant Version_32 := 16#0a6560cb#;
   pragma Export (C, u00137, "packagecartaB");
   u00138 : constant Version_32 := 16#bf585564#;
   pragma Export (C, u00138, "packagecartaS");
   ...
   u00141 : constant Version_32 := 16#43c93cd6#;
   pragma Export (C, u00141, "dcolaB");
   u00142 : constant Version_32 := 16#238be54a#;
   pragma Export (C, u00142, "dcolaS");
   u00143 : constant Version_32 := 16#eef2a550#;
   pragma Export (C, u00143, "packagecategoriaB");
   u00144 : constant Version_32 := 16#7d8e1e5d#;
   pragma Export (C, u00144, "packagecategoriaS");
   u00145 : constant Version_32 := 16#5a895de2#;
   pragma Export (C, u00145, "system__pool_globalB");
   u00146 : constant Version_32 := 16#7141203e#;
